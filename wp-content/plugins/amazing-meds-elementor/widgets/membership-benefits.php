...
/**
 * Amazing Meds Membership Benefits Widget
 */
class AM_Membership_Benefits_Widget extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'am_membership_benefits';
    }

    public function get_title()
    {
        return esc_html__('AM Membership Benefits', 'amazing-meds-elementor');
    }
